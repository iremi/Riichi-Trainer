export const ru = {
    translations: {
        ...
        trainer: {
            ...
            complete: " Ваша рука собрана.<br/><b>Поздравляем! Ваша эффективность была {{achieved}}/{{total}}, или {{percent}}%.</b>",
        ...
        history: {
            ...
            verbose: {
                ...
                acceptance: " количество тайлов улучающих вашу руку теперь <c>{{count}}</c>.",
                acceptance_plural: " количество тайлов улучающих вашу руку теперь <c>{{count}}</c>.",
        ...
        settings: {
            ...
            useTimer: "Включить таймер",
            time: "Время для каждого решения:",
            extraTime: "Дополнительное время для каждой руки:",
            seconds: "секунды"
        },
        stats: {
