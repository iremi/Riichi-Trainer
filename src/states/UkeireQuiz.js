        ...
        return (
            <Container fluid className="trainer-container">
                ...
                <Row className="mt-2 no-gutters">
                    <History history={this.state.history} concise={this.state.settings.extraConcise} verbose={this.state.settings.verbose} spoilers={this.state.settings.spoilers} tileImages={this.state.settings.tileImages} progressBar={this.state.settings.progressBar}/>
